...
Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</Text>
            ...
            <TouchableOpacity disabled={ !this.state.accepted } onPress={ ()=>alert("Termos e Condições Aceitados") } style={ this.state.accepted ? styles.button : styles.buttonDisabled }><Text style={styles.buttonLabel}>Accept</Text></TouchableOpacity>
      </View>
    );
  }
